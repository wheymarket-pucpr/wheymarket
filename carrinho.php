...
<body>
  <section>
    ...
    ?>
      <?php if ($rows > 0) : // Verifica se o usuario ja adicionou algum produto ao carrinho ?>
        <div>
                ...
                <tbody>
                  <?php while ($produto = mysqli_fetch_assoc($result2)) : ?>
                    <tr>
                      ...
                      <td>
                        <div class="qty">
                          <button type="button" class="btn btn-outline-primary btn-sm" onclick="alterarQtdeProdutoCarrinho(2, <?php echo $produto['idProduto'] ?>, <?php echo $fk_Carrinho_ID ?>)">
                            <i class="fa-solid fa-minus"></i>
                          </button>
                          <span class="p-2" data-product-quantidade=<?php echo $produto['idProduto'] ?>><?php echo $produto['quantidade'] ?></span>
                          <button type="button" class="btn btn-outline-primary btn-sm" onclick="alterarQtdeProdutoCarrinho(1, <?php echo $produto['idProduto'] ?>, <?php echo $fk_Carrinho_ID ?>)">
                      ...
                      <td>
                        <a href="excluirProdutoCarrinho.php?&idCarrinho=<?php echo $fk_Carrinho_ID ?>&idProduto=<?php echo $produto['idProduto'] ?>" class="btn btn-outline-danger btn-sm">
